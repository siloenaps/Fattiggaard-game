...
(lib.slide_2_7_1_mine = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},330).to({state:[{t:this.instance_2}]},374).to({state:[{t:this.instance_3}]},412).to({state:[{t:this.instance_4}]},170).to({state:[{t:this.instance_5}]},271).wait(479));
