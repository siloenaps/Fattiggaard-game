...
// stage content:
(lib.slide_4_5_1_BC = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1889));
	...
	this.instance_3 = new lib.slaughter07();

	this.instance_4 = new lib.slaughter08();

	this.instance_5 = new lib.slaughter02();

	this.instance_6 = new lib.slaughter09();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},107).to({state:[{t:this.instance_2}]},288).to({state:[{t:this.instance_3}]},151).to({state:[{t:this.instance_4}]},194).to({state:[{t:this.instance_5}]},95).to({state:[{t:this.instance_6}]},389).to({state:[{t:this.instance_2}]},485).wait(180));
